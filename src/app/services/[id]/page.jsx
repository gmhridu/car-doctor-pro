...
const ServiceDetails = async({params}) => {
    ...
    const {_id, title, img, description,  price, facility} = service || {};
    return (
          ...
          <div className="grid grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-gray-100">
              ...
              <Link href={`/checkout/${_id}`}>
                <button className="bg-rose-500 px-3 py-2 hover:bg-rose-700 rounded-lg mt-2 w-full text-white">Check out</button>
              </Link>
            </div>
          </div>
        </div>
